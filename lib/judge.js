        ...
        return {
            ...
            browser: function () {
                ...
                var
                    ...
                    //匹配mobile safari
                    mobileSafari = ua.match(/mobile safari/) == 'mobile safari' &&judge.isMobile(),
                ...
                for(var i = 0,l= browsers.length;i < l;i++){
                    if(browsers[i]){
                        return bn[i].toLowerCase();
                    }
                }
                //mobile IE10
                if(MSIE>0 && IEMobile){
                    return "Mobile IE"+parseInt(ua.substring(MSIE + 5,ua.indexOf(".",MSIE)),10);
                    //pc ie
            ...
            platform : function(){
                ...
                var dn = [
                    "iPad","Android","iOS","Windows Phone","Mac","Windows","Linux","Blackberry","Android Tablet"
                ];
                for(var k =0;k<device.length;k++){
                    if(device[k]){
                        return dn[k].toLowerCase();
                    }
                }
            ...
            haveSpecialChar: function(str){
                var pattern = str.match(/[^A-Za-z0-9]/);
                return !!pattern;
            }
        }
    })();
