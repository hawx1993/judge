        ...
        return {
            ...
            browser: function () {
                var
                    ...
                    isQQMobile= /qqbrowser/ &&!!ua.match(/(iPhone|Android|ios|iPad)/i),
                ...
                var browsers = [
                    isFirefox,isIosChrome,isAndroidChrome,isIosSafari,
                    isIpadSafari,isEdge,isSougou,isLiebao,isLiebaoMobile,isWeiXin,isUC,
                    isUCMobile,isBaidu,isBaiduMobile,isQQMobile,isQQBrowser,isOpera,
                    isMiuiBrowser,isOppoBrowser,isChrome,isSafari
                ];
                var bn = [
