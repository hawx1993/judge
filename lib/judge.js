        ...
        return {
            ...
            browser: function () {
                var IE6 = ua.indexOf("msie 6.0") > 0,
                    ...
                    UC = ua.match(/ubrowser/i)==='ubrowser',
                    mobileUC = ua.match(/ucbrowser/i)=='ucbrowser',
                    //避免只匹配browser而引发的冲突
                    mobBaidu = ua.match(/baidubrowser/i)=='baidubrowser',
                    QQBrowser = ua.match(/qqbrowser/i)=='qqbrowser' ,
                ...
                var browsers = [
                    IE6, IE7, IE8, IE9, IE10, IE11, IE, IEMobile,Firefox, Edge,Sougou,Liebao,lbmobile,Weixin,UC,mobileUC,mobBaidu,QQBrowser,Opera,mobileSafari,MobileChrome,Chrome,Safari
                ];
                var bn = [
