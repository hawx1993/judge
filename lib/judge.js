        ...
        return {
            ...
            browser: function () {
                var IE6 = ua.indexOf("msie 6.0") > 0,
                    ...
                    IE8 = ua.indexOf("msie 9.0") >0 && !window.innerWidth,
                    IE9 = ua.indexOf("msie 9.0") > 0,
                    IE10 = ua.indexOf("msie 10.0") > 0,
                    IE11 = ua.indexOf("msie 11.0") > 0,
                    IE = !!window.ActiveXObject || "ActiveXObject" in window,
                    Firefox = ua.indexOf("firefox") > -1,
                    Edge = ua.indexOf("edge") > -1,
                    Sougou = /metasr/.test(ua),
                    Liebao = /lbbrowser/.test(ua),
                    Weixin = /micromessenger/.test(ua),
                    UC = /ucweb/.test(ua),
                    QQ = ua.indexOf('qqbrowser') > -1 && ua.indexOf('chrome') < 1,
                    Baidu = ua.indexOf('baidu') > -1&& ua.indexOf('chrome') < 1,
            ...
            platform : function(){
                ...
                var device =[
                    iPad,Android,iPhone,WinPhone,Mac,Windows,Linux,Blackberry,AndroidTablet
                ];
                var dn = [
                    "iPad","Android","iPhone","WinPhone","Mac","Windows","Linux","Blackberry","AndroidTablet"
                ];
